"""
Django settings for superPlat project.
...
SECRET_KEY = 'jghbaugjw$=3nqn-goz(3545ne4yt7p&643^ab$3qdn9qri+t1'
...
ROOT_URLCONF = 'superPlat.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'superPlat/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'superPlat.wsgi.application'
